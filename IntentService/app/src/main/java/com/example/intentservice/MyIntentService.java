...
public class MyIntentService extends IntentService {
    ...
    private void handleActionFoo(String param1) {
        ...
        Intent intent = new Intent(MainActivity.INTENT_ACTION1);
        intent.putExtra("broadcast1", primeNumber(Integer.parseInt(param1))?"yes":"no");
    ...
    private void handleActionBaz(String param1) {
        ...
        Intent intent = new Intent(MainActivity.INTENT_ACTION2);
        intent.putExtra("broadcast2", primeNumber(Integer.parseInt(param1))?"yes":"no");
        sendBroadcast(intent);
    }
